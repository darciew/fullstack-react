...
module.exports = {
  'forms test case': function(client) {
    ...
    // 06
      .waitForElementPresent("//a[normalize-space(text())='06-state-input-multi']")
    ...
    // 07
      .waitForElementPresent("//a[normalize-space(text())='07-basic-validation']")
    ...
    // 08
      .waitForElementPresent("//a[normalize-space(text())='08-field-component-form']")
      ...
      .waitForElementPresent("div:nth-child(13) form div:nth-child(3) input")
      .clearValue("div:nth-child(13) form div:nth-child(3) input")
      .setValue("div:nth-child(13) form div:nth-child(3) input", "david@mazzo.com")
      .waitForElementPresent("input[type='submit']")
      .click("input[type='submit']")
      /* submit form */
      .useXpath()
    ...
    // 09
      ...
      .waitForElementPresent("div:nth-child(13) form div:nth-child(3) input")
      .clearValue("div:nth-child(13) form div:nth-child(3) input")
      .setValue("div:nth-child(13) form div:nth-child(3) input", "nate@natemurray.com")
      ...
      .waitForElementPresent("div:nth-child(13) form div:nth-child(3) input")
      .clearValue("div:nth-child(13) form div:nth-child(3) input")
      .setValue("div:nth-child(13) form div:nth-child(3) input", "david@guttman.com")
    ...
    // 10
      .waitForElementPresent("//a[normalize-space(text())='10-remote-persist']")
